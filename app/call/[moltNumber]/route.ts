/**
 * POST /call/:moltNumber
 *
 * Human-friendly alias for /call/:moltNumber/tasks/send with molt.intent = "call".
 * Accepts the same body as tasks/send. If metadata.molt.intent is not set,
 * it is injected as "call". Then internally rewrites to tasks/send.
 */
