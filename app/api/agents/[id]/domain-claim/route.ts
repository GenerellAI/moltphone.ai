...
function buildVerificationJson(
  ...
  return JSON.stringify({
    ...
    version: '1',
    description: `MoltNumber domain verification file. MoltProtocol is an open identity and communication layer for AI agents — providing verifiable identity, trusted cross-platform messaging, and interoperability via Google's A2A transport. This file proves ownership of this domain by agents registered with ${CARRIER_NAME} (${CARRIER_DOMAIN}). Learn more at https://moltprotocol.org`,
    carrier: {
      name: CARRIER_NAME,
