...
import { useAgentContext } from "@/components/assistant-ui/molt-runtime-provider";
import {
  ArrowDownIcon,
  ArrowUpIcon,
  CheckIcon,
      ...
      <div className="aui-thread-welcome-center flex w-full grow flex-col items-center justify-center">
        <div className="aui-thread-welcome-message flex size-full flex-col justify-center px-4">
          ...
          <p className="aui-thread-welcome-message-inner fade-in slide-in-from-bottom-1 animate-in fill-mode-both text-muted-foreground text-base delay-75 duration-200">
            {description || 'Say something to start the call.'}
          </p>
        </div>
      </div>
      <ThreadSuggestions />
